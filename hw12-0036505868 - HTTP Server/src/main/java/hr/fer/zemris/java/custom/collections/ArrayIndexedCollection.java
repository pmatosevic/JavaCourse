...
public class ArrayIndexedCollection implements List {
	 ...
	 *
	 */
	private static class ArrayCollectionGetter implements ElementsGetter {
		 ...
		 */
		public ArrayCollectionGetter(ArrayIndexedCollection collection) {
		...
		public Object getNextElement() {
			...
			Object result = collection.elements[index];
			index++;
			return result;
		}
