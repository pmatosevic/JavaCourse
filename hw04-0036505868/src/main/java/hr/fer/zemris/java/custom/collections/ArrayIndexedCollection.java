...
public class ArrayIndexedCollection<T> implements List<T> {
	...
	public ElementsGetter<T> createElementsGetter() {
		return new ArrayCollectionGetter<>(this);
	}
	
	
	/**
	 * Represents an {@link ElementsGetter} for {@link ArrayIndexedCollection}
	 * @author Patrik
	 *
	 */
	private static class ArrayCollectionGetter<T> implements ElementsGetter<T> {
		...
		/**
		 * Creates a new {@code ArrayCollectionGetter}
		 * @param collection collection
		 */
		public ArrayCollectionGetter(ArrayIndexedCollection<T> collection) {
		...
		public T getNextElement() {
			...
			T result = collection.elements[index];
			index++;
			return result;
		}
