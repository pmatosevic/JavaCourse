...
public class ValueWrapper {
	...
	public void add(Object incValue) {
		value = performOperation(Integer::sum, Double::sum, incValue);
	}
	...
	public void subtract(Object decValue) {
		value = performOperation((a, b) -> a - b, (a, b) -> a - b, decValue);
	}
	...
	public void multiply(Object mulValue) {
		value = performOperation((a, b) -> a * b, (a, b) -> a * b, mulValue);
	}
	...
	public void divide(Object divValue) {
		value = performOperation((a, b) -> a / b, (a, b) -> a / b, divValue);
	}
	 ...
	 */
	private Number tryConvert(Object obj) {
		if (obj == null) {
	 ...
	 * @throws ArithmeticException in case of an integer division by 0
	 */
	private Number performOperation(BinaryOperator<Integer> intOper, BinaryOperator<Double> doubleOper, Object other) {
		Number oper1 = tryConvert(value);
