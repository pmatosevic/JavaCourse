...
public class LinkedListIndexedCollectionTest {
	...
	void testInsertBigCollection() {
		LinkedListIndexedCollection coll = createBigCollection();
	...
	@Test
	void testAddAll() {
		LinkedListIndexedCollection newColl = new LinkedListIndexedCollection();
		newColl.add("added1");
		newColl.add("added2");
	...
	private LinkedListIndexedCollection createBigCollection() {
		LinkedListIndexedCollection coll = new LinkedListIndexedCollection();
