...
public interface Environment {
	 ...
	 * @param docCollection document collection
	 */
	void setDocumentCollection(DocumentCollection docCollection);
	
	/**
	 * Returns results from the last query
	 * @return results from the last query
	 */
	List<SimilarityResult> getResults();
	
	/**
	 * Sets the results
	 * @param results the results 
	 */
	void setResults(List<SimilarityResult> results);
